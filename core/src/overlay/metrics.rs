    ...
    fn update_rates(&mut self) {
        ...
        if elapsed >= self.tick_interval {
            ...
            self.fifteen_min_rate =
                self.fifteen_min_rate + alpha_15 * (rate - self.fifteen_min_rate);
...
impl OverlayMetrics {
    ...
    pub async fn new() -> Self {
        ...
        let connection_failures = registry
            .register_counter("overlay.connection_failures")
            .await;
        ...
        let relay_latency = registry
            .register_histogram("overlay.relay_latency", 1000)
            .await;
        let chunk_size = registry
            .register_histogram("overlay.chunk_size", 1000)
            .await;
