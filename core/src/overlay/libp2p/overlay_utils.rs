...
use libp2p::gossipsub::{IdentTopic, Event as GossipsubEvent};
...
use crate::overlay::peer::{LocalPeerId, Peer, PeerInfo, ConnectionStatus};
...
pub async fn disconnect_peer(
    ...
    swarm.disconnect_peer_id(libp2p_peer_id)
...
pub async fn connect_peer_impl(
    ...
    // 1. Use the swarm to dial the peer
    // 2. Wait for connection establishment
    // 3. Return the actual peer information
